...
class HaNLPUtil:
    ...
    def __init_util(self):
        ...
        # 标准分词
        # StandardTokenizer = JClass("com.hankcs.hanlp.tokenizer.NShortSegment")
        # self.segment = StandardTokenizer.segment(self.sentence)

        # NLP 分词, 更精准的中文分词、词性标注与命名实体识别
        # NLPTokenizer = JClass("com.hankcs.hanlp.tokenizer.NLPTokenizer")
        # self.segment = NLPTokenizer.segment(self.sentence)

        # 进行分词 CRF分词, CRF对新词有很好的识别能力, 但是开销较大
        CRFnewSegment = HanLP.newSegment("crf")
        self.segment = CRFnewSegment.seg(self.sentence)
